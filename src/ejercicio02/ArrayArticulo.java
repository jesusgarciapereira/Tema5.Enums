...
public class ArrayArticulo {
	...
	public static boolean anniadirArticulo(String codigo, String descripcion, double precioDeCompra,
			double precioDeVenta, int stock, Departamento departamento) {
		...
		Articulo articulo = new Articulo(codigo, descripcion, precioDeCompra, precioDeVenta, stock, departamento);
