...
import ejercicio02.Articulo.Departamento;
...
public class Gestisimal {
	...
	public static void main(String[] args) {
		...
		int stock;
		// Departamento que le pediremos al usuario
		String cadenaDepartamento = "";
		...
		do {
			...
			case 2:
				...
				// Le pedimos al usuario el departamento del nuevo artículo
				System.out.println("Introduzca el departamento del nuevo artículo");
				// Lo asignamos a la cadena
				cadenaDepartamento = sc.nextLine();
				// Y luego lo asignamos al enum Departamento
				departamento = Articulo.Departamento.valueOf(cadenaDepartamento);
				

				// Si se ha podido añadidir el artículo
				if (ArrayArticulo.anniadirArticulo(codigo, descripcion, precioDeCompra, precioDeVenta, stock, departamento))
